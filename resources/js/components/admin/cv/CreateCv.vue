<template>
    <div class="modal" tabindex="-1" id="creationCvModal">
        <div class="d-flex justify-content-center modal-dialog modal-lg" style="margin-top: 100px; line-height: 30px; ">
            <div class="m-2 modal-content">
                <div class="modal-header pb-0 mb-0">
                        <h1 style="border-radius: 5px 5px 0px 0px; padding: 5px;">Créer un cv</h1>
                ...
                <div class="modal-body" style="line-height: 40px;">
                    <div>
                        <div class="form-group">
                            ...
                            <input id="nom" type="text" class="form-control" v-model="cv.name">
                        </div>
                        <div class="form-group">
                            <label for="desc">Description du projet</label>
                            <trumbowyg class="form-control" id="desc" v-model="cv.desc"></trumbowyg>
                        </div>
                        <div class="d-flex justify-content-between">
                            <div class="mb-5 mt-3">
                                <button class="btn btn-success" data-bs-dismiss="modal" @click="save(cv, '/gestion/cv/save')">Valider</button>
                            </div>
                        </div>
                    </div>
                </div>
